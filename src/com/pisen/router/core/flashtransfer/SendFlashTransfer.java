...
//			values.put(TransferInfo.Table.takeControl, String.valueOf(info.takeControl));
...
//	private void sendCompleteBroadcast(TransferInfo info) {
//		Intent in = new Intent(FlashTransferManager.ACTION_TRANSFER_COMPLETE_SEND);
//		in.putExtra("id", info._id);
//		context.sendBroadcast(in);
//	}
...
//		protected DefaultHttpClient createDefaultClient() {
//			HttpParams params = new BasicHttpParams();  
//			// set timeout
