...
import com.pisen.router.core.music.LocalMusicPlayback;
...
import com.pisen.router.core.music.XiaMiMusicPlayback;
...
//				showPlayAnimation(false);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		popupWindow.dismiss();
		if (position == 0) {// 选择本机
			if (musicPlayer instanceof LocalMusicPlayback || musicPlayer instanceof XiaMiMusicPlayback) {
